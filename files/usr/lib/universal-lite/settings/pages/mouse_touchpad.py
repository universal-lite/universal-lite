...
class MouseTouchpadPage(BasePage):
    ...
    def build(self):
        ...
        # -- Touchpad --
        page.append(self.make_group_label(_("Touchpad")))
        ...
        page.append(self.make_setting_row(_("Tap to click"), "", tp_tap))
        ...
        page.append(self.make_setting_row(_("Natural scrolling"), _("Content moves with your fingers"), tp_natural))
        ...
        page.append(self.make_setting_row(_("Pointer speed"), "", tp_speed))
        ...
        page.append(self.make_setting_row(_("Scroll speed"), "", tp_scroll))

        # -- Mouse --
        page.append(self.make_group_label(_("Mouse")))
        ...
        page.append(self.make_setting_row(_("Natural scrolling"), "", mouse_natural))
        ...
        page.append(self.make_setting_row(_("Pointer speed"), "", mouse_speed))

        page.append(self.make_setting_row(_("Acceleration"), "", self.make_toggle_cards(
